...
import { View, TouchableOpacity, Text, StyleSheet, Image, RefreshControl } from 'react-native';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { StatusBar } from 'react-native';
import { useIsFocused, NavigationContainer } from "@react-navigation/native";
import { getphoto } from "../api";
import { Icon } from 'react-native-elements'
import DefaultImage from '../www.png';
    ...
    >
      ...
      {ww ?
        <TouchableOpacity style={styles.buttonUpdate} onPress={() => {
          ...
          <Image style={{ width: "61%", aspectRatio: 1, borderRadius: 0 }}
            source={{
              uri: DEFAULT_IMAGE
            }}
          />
        ...
        :
        <>
          <TouchableOpacity style={styles.buttonSave} onPress={() => { props.navigation.navigate("TaskFormLogin") }}>
...
/*
<TouchableOpacity style={styles.buttonSave} onPress={() => { props.navigation.navigate("User") }}>
            <Text style={styles.buttonText}>REGÍSTRESE</Text>
          </TouchableOpacity>
